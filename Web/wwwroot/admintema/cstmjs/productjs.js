...
function UploadGetir(result) {
    ...
    for (let i = 0; i < filenameler.length; i++) {
        ...
        if (filenameler[i] != "") {
            ...
            var tur = "<img src='../../upload/images/" + filenam[0] + "' width=\"100\" />";
            var liste = "<div id='fotoDisDiv' class=" + fileClass[0] + "><div id='fotoDiv'><span>" + tur + "</span></div><a class=\"silBtnFoto\" id=" + filenameler[i] + " onclick='DeleteFile(\"" + filenam[0] + "\")'></a></div>"; // Binding the file name;
